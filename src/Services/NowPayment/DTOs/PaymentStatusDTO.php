...
final readonly class PaymentStatusDTO
{
    ...
    {
        return new self(
            payment_id: (int) $data['payment_id']                ?? null,
            ...
            price_amount: (float) $data['price_amount']          ?? null,
            price_currency: (string) $data['price_currency']     ?? null,
            pay_amount: (float) $data['pay_amount']              ?? null,
            actually_paid: (float) $data['actually_paid']        ?? null,
            pay_currency: (string) $data['pay_currency']         ?? null,
            order_id: $data['order_id']             !== null ? (string) $data['order_id'] : null,
            order_description: $data['order_description']        ?? null,
            purchase_id: (int) $data['purchase_id']              ?? null,
            outcome_amount: (float) $data['outcome_amount']      ?? null,
            outcome_currency: (string) $data['outcome_currency'] ?? null,
